...
(select JSON_OBJECT_AGG(country, cnt) from countries c where c.period_year = a.period_year and c.period_quarter = a.period_quarter and c.author = a.author) as country_distribution
from authors a
