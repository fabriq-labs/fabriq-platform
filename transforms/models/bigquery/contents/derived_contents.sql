...
contents as (
	...
	inner join {{ source('atomic', 'events') }} AS e
	    ON pv.event_id = e.event_id AND pv.collector_tstamp = e.collector_tstamp,
	UNNEST(e.contexts_com_snowplowanalytics_snowplow_web_page_1_0_0) AS wp,
	UNNEST(e.contexts_io_snowplow_foundation_content_1_0_0) AS c
)
