...
from
	video_content
group by
	EXTRACT(MONTH FROM collector_tstamp),
...
select 
    ...
    from
      cities
    where cities.period_month =  v.period_month and cities.period_year =  v.period_year and cities.site_id = v.site_id and cities.media_id = v.media_id and cities.media_label = v.media_label
    ) as top_cities,
    (
    select
    ...
    where re.period_month = v.period_month and re.period_year = v.period_year and re.site_id = v.site_id and re.media_id = v.media_id  and re.media_label = v.media_label
    ) as top_referers,
    (
