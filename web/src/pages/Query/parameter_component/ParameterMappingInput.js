...
import HelpTrigger from "../editor-components/helptrigger";
import { ParameterMappingType } from "../../../api/widget";
import { Parameter, cloneParameter } from "../../../api/parameters";
    ...
    return (
      ...
      >
        <Button
          size="small"
          type="dashed"
          data-test={`EditParamMappingButon-${mapping.param.name}`}
        >
          <Icon type="edit" />
        </Button>
      </Popover>
