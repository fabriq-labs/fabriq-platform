...
import DateRangeInput from "../parameter_component/DateRangeInput";
import DateTimeRangeInput from "../parameter_component/DateTimeRangeInput";
import DynamicButton from "./DynamicButton";
import {
  isDynamicDateRange,
  getDynamicDateRangeFromString
} from "../../../api/parameters/DateRangeParameter";
...
const DYNAMIC_DATE_OPTIONS = [
  {
    ...
    label: () =>
      `${getDynamicDateRangeFromString("d_this_week")
        .value()[0]
        .format("MMM D")} - ${getDynamicDateRangeFromString("d_this_week")
        .value()[1]
        .format("MMM D")}`
  },
  {
  ...
  },
  {
    ...
    label: () =>
      `${getDynamicDateRangeFromString("d_last_week")
        .value()[0]
        .format("MMM D")} - ${getDynamicDateRangeFromString("d_last_week")
        .value()[1]
        .format("MMM D")}`
  },
  {
