...
import resizeObserver from "../../../api/resizeObserver";
import QuerySnippet from "../../../api/query_snippet";
import { AceEditor, snippetsModule, updateSchemaCompleter } from "./ace";

import QueryEditorControls from "../query_control/query_control";
import "./index.less";

const editorProps = { $blockScrolling: Infinity };

const QueryEditor = React.forwardRef(
  (
    {
      className,
      syntax,
    ...
    useEffect(() => {
      if (editorRef) {
        ...
        updateSchemaCompleter(editorId, schemas);
        return () => {
...
QueryEditor.propTypes = {
  ...
  schemas: PropTypes.array, // eslint-disable-line
